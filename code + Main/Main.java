...
public class Main {
    ...
    public static void testSExp(Path sexpPath, Parse parse, String message) throws IOException {
        ...
        String expectedSExp = normalizeSExpression(fixNewlines(Files.readString(sexpPath)));
    ...
    public static void testWithFile(Path langPath) {
        try {
            ...
            // each program is a test case
            // ex. /lang-test-cases/01-spaces/justinnhli/zero.lang
            ...
            // parse the code
            Parse parse = Main.parser.parse(program, "program");
            ...
            if (parse == null) {
                ...
                Main.interpreter.output = "";
                Main.interpreter.curr_environment = new Environment();
    ...
    public static void main(String[] args) throws IOException {
        Main.testWithDirectory(Paths.get("/Users/lishuting/desktop/lang-test-cases-main"));  
        // /Users/lishuting/desktop/lang-test-cases-main
        // /Users/lishuting/desktop/git_shuting/lang-test-cases
    }
